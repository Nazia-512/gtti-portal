...
export default async function AdminDashboard() {
  ...
  const QUICK_ACTIONS = [
    ...
    { icon: ImageIcon,   label: 'Manage Slider',     color: 'text-cyan-400',   href: '/admin/slider'        },
  ...
  return (
    <div className="min-h-screen" style={{ background: 'var(--bg-primary)' }}>
      <div className="max-w-7xl mx-auto px-6 py-10">
        <Link href="/" className="inline-flex items-center gap-2 text-sm mb-8 hover:text-cyan-400 transition-colors" style={{ color: 'var(--text-secondary)' }}>
        ...
        <div className="flex items-center justify-between mb-10 flex-wrap gap-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="font-display font-bold text-3xl text-red-400">Admin Dashboard</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 glass-card rounded-2xl p-6">
            <div className="flex items-center justify-between mb-5">
              ...
              <Link href="/admin/students" className="text-xs text-cyan-400 hover:text-cyan-300 transition-colors">View All →</Link>
            </div>
                ...
                recentStudents.map((s, i) => (
                  <div key={i} className="flex items-center gap-4 py-3 border-b last:border-0" style={{ borderColor: 'var(--border)' }}>
                    ...
                    <div className="text-right flex-shrink-0">
                      <span className="badge badge-cyan mb-1">active</span>
          ...
          <div className="space-y-6">
            ...
            <div className="glass-card rounded-2xl p-6">
              <div className="flex items-center justify-between mb-5">
                ...
                <Link href="/admin/announcements/new" className="text-xs text-cyan-400 hover:text-cyan-300 transition-colors">+ Add</Link>
              </div>
              <div className="space-y-3">
              ...
              <div className="space-y-1">
                {QUICK_ACTIONS.map((action) => (
                  <Link
                    key={action.label}
                    href={action.href}
                    className="w-full flex items-center gap-3 p-3 rounded-xl text-sm font-medium transition-all hover:bg-white/5"
