      ...
      <div className="max-w-7xl mx-auto">
        ...
        {trades.length === 0 ? (
          ...
          <div className="glass-card rounded-2xl text-center py-16 max-w-xl mx-auto">
            ...
            <p style={{ color: 'var(--text-muted)' }}>Trades jald hi yahan add kiye jayenge.</p>
          </div>
        ) : (
          <div className="relative">
            ...
            <div
              ref={trackRef}
              className="trades-track flex gap-5 overflow-x-auto snap-x snap-mandatory scroll-smooth pb-2"
